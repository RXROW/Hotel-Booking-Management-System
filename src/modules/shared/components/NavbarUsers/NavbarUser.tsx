...
export default function NavbarUser() {
  ...
  return (
    <AppBar className='UserNav' position="static" sx={{ backgroundColor: '#ffffff', position: 'sticky', top: 0, zIndex: 1000 }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, justifyContent: 'end', display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to='/' style={{ textDecoration: 'none' ,color:"#3252DF"}}>Home</Link>
              </MenuItem>
              <MenuItem onClick={handleCloseNavMenu}>
                <Link to='/explore-all-rooms' style={{ textDecoration: 'none',color:"#152C5B" }}>Explore</Link>
              </MenuItem>
